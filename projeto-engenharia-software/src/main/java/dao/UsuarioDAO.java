...
public class UsuarioDAO {
	...
	private static final String Update_SQL = "UPDATE public.usuario SET nome = ?, email = ?, senha = ?, nivel_permissao = ?, WHERE id = ?";
	...
	public static boolean atualizarQuadra(Usuario u) {
		boolean sucesso = false;
